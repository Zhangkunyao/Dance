...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--class_num', type=int, default=20, help='# of class number')
        self.parser.add_argument('--ngf', type=int, default=64, help='# of gen filters in first conv layer')
        self.parser.add_argument('--ndf', type=int, default=64, help='# of discrim filters in first conv layer')
        self.parser.add_argument('--which_model_netC', type=str, default='Resnet', help='selects model to use for netC')
        self.parser.add_argument('--which_model_netD', type=str, default='basic', help='selects model to use for netD')
        self.parser.add_argument('--which_model_netG', type=str, default='resnet_9blocks', help='selects model to use for netG')
        self.parser.add_argument('--which_model_netS', type=str, default='resnet_9blocks', help='selects model to use for netSal')
        ...
        self.parser.add_argument('--display_id', type=int, default=8, help='window id of the web display')
