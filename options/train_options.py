...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--niter_decay', type=int, default=700, help='# of iter to linearly decay learning rate to zero')
        ...
        self.parser.add_argument('--lr_decay_iters', type=int, default=200, help='multiply by a gamma every lr_decay_iters iterations')
